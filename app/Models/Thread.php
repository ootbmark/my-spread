...
class Thread extends Model implements HasFiles
{
     ...
     * @var string[]
     */
    protected $fillable =  ['user_id', 'group_id', 'subject', 'body', 'location', 'is_closed', 'status',
        'source_id', 'is_daily_sent', 'is_weekly_sent', 'activity_date'];
