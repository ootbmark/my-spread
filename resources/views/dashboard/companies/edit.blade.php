                ...
                <div class="kt-subheader  kt-grid__item" id="kt_subheader">
                    <div class="kt-container  kt-container--fluid align-items-center">
                        <div class="kt-subheader__main">
                            <h3 class="kt-subheader__title">{{__('Edit Company')}}</h3>
                            <span class="kt-subheader__separator kt-subheader__separator--v"></span>
                            <div class="kt-subheader__breadcrumbs">

                                <a href="{{route('companies.index')}}" class="kt-subheader__breadcrumbs-home"><i class="flaticon2-back"></i></a>
                                <span class="kt-subheader__breadcrumbs-separator"></span>
                                <a href="{{route('companies.index')}}" class="kt-subheader__breadcrumbs-link">
                                    {{__('Companies')}}</a>
                                <span class="kt-subheader__breadcrumbs-separator"></span>
                                <a href="{{route('companies.edit', $company->id)}}" class="kt-subheader__breadcrumbs-link">
                                    {{__('Edit Company')}} - {{$company->id}} </a>
                            </div>
                        </div>
                        <div>
