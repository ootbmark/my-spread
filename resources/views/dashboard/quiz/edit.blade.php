...
@section('content')
    ...
    <div class="profile-content">
        ...
        <div class="discussions-container ml-0 mt-4 p-0">
            <div class="kt-content  kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor" id="quiz">
                    ...
                    <div class="kt-container  kt-container--fluid align-items-center">
                        <div class="kt-subheader__main">
                            ...
                            <div class="kt-subheader__breadcrumbs">
                                ...
                                <span class="kt-subheader__breadcrumbs-separator"></span>
                                <a href="{{route('forms.edit', $quiz->id)}}" class="kt-subheader__breadcrumbs-link">
                                    Form - {{$quiz->id}} </a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="kt-portlet">
                                ...
                                <quiz-main v-bind:quiz="{{json_encode($quiz)}}"  :datatime="'{{ \Carbon\Carbon::parse($quiz->time_limit)->addDay()->format('Y-m-d') }}'"></quiz-main>
