                ...
                <table class="table">
                    ...
                    <tr>
                        ...
                        <td class="action-buttons">
                            <a href="{{route('users.show', $user->id)}}" class="action-link action-link-blue" title="View"><i class="fa fa-eye"></i></a>
                            <a href="#" class="action-link action-link-blue send-message" data-id="{{$user->id}}" data-email="{{$user->email}}" title="Message"><i class="fa fa-envelope"></i></a>
                            <a href="{{route('dashboard.users.edit', $user->id)}}" class="action-link action-link-green" title="Edit"><i class="fa fa-pencil"></i></a>
            ...
            <div class="modal-content">
                <form class="modal-body text-center p-4" action="{{route('dashboard.users.message')}}" method="POST">
                    ...
                    <div class="form-group">
                        <input type="text" class="form-control" id="subject" placeholder="Enter the subject of the email here..." required name="subject">
                    </div>
...
@section('scripts')
    ...
    <script>
        $('.send-message').click(function ()
        {
            ...
            $('#subject').val('');
            $('.editor-div').html('');
            $('.editor-div').html('<textarea name="message" id="message" placeholder="Enter your message here"></textarea>');
            ClassicEditor
