                    ...
                    <div class="kt-container  kt-container--fluid align-items-center">
                        <div class="kt-subheader__main">
                            ...
                            <div class="kt-subheader__breadcrumbs">
                                ...
                                <a href="{{route('groups.index')}}" class="kt-subheader__breadcrumbs-home"><i
                                        class="flaticon2-back"></i></a>
                                <span class="kt-subheader__breadcrumbs-separator"></span>
                                <a href="{{route('groups-for-quiz.index')}}" class="kt-subheader__breadcrumbs-link">
                                    {{__('Groups')}}</a>
                                <span class="kt-subheader__breadcrumbs-separator"></span>
                                <a href="{{route('groups-for-quiz.create')}}" class="kt-subheader__breadcrumbs-link">
                                    {{__('Create New Group For Form')}}</a>
                            </div>
                        </div>
                        <div class="">
{{--                            <a href="" class="btn btn-secondary j_return_back">{{__('Cancel')}}</a>--}}
                            <button type="submit" class="btn btn-primary"
                                    id="object-form-confirm">{{__('Save')}}</button>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="kt-portlet">
                                ...
                                <form action="{{route('groups-for-quiz.store')}}" method="post"
