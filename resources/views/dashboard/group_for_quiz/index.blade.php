                                    ...
                                    <div class="kt-portlet__head-toolbar">
                                        <div class="kt-portlet__head-wrapper">
                                            <div class="kt-portlet__head-actions">
                                                <a href="{{route('groups-for-quiz.create')}}"
                                                   class="btn btn-brand btn-elevate btn-icon-sm">
                                                    <i class="flaticon2-plus"></i>
                                                    {{__('Create New Group For Form')}}
                                                </a>
...
@section('scripts')
    ...
    <script>
        $('.dataTable').DataTable({
            ...
            responsive: true,
            aaSorting: [[0, "desc"]],
            ajax: "{{ route('groups-for-quiz.dataTable')}}",
            columns: [
                // {name: 'id'},
                {name: 'name'},
                /*   {
                       ...
                       render: function (name) {
                           ...
                           for (let i =0; i<name.length; i++ ){
                               if (i == name.length-1){
                                   div+=(name[i].first_name)
                               } else{
                                   div+=(name[i].first_name + ' ' + name[i].last_name+', ')
                               }
                           }
                           return div;
                       }
