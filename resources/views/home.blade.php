...
@section('content')
    ...
    <section class="my-container mb-5 pt-5" id="second-section">
        ...
        <p class="mb-5">Over the past decade, My-Spread has grown to become the leading oil and gas drilling forum for technical
            ...
            <br><br>If you haven’t signed up already please do so, and you can ask or answer your first question right now. Welcome to our drilling community!
        </p>
        ...
        <div class="main-section d-flex flex-wrap pb-4">
            ...
            <div class="section-left">
                ...
                <h3 class="title-h3 font-medium pb-0">
                    <a href="{{route('discussions.index')}}?unanswered=1" class="link-1 d-flex justify-content-between border-0">
                        NOVICE QUESTIONS
                    </a>
                </h3>
                ...
                <a href="https://rp-squared.com/workshops/beyond-video-conferencing-and-technical-facilitation-service" rel="noopener" target="_blank" class="mt-5 d-block">
                    <picture>
