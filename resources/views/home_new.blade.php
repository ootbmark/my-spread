                ...
                <div class="flexbox">
                        ...
                        <div class="col-md-8 col-sm-12 col-xs-12">
                            <div class="right-captions animated fadeInRight">
                                ...
                                <div class="stroked-button">
                                    @guest
                                    <a href="{{route('login')}}" class="link" data-id="second-section">LOGIN / REGISTER</a>
                                    @else
                                        <a href="{{route('discussions.check')}}" data-id="second-section">START A NEW DISCUSSION</a>
                                    @endguest
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="arrow">
                        <a href="#welcome" class="scroll-link" data-id="second-section">
                            ...
                            <lord-icon src="https://cdn.lordicon.com/wtfdpwey.json" trigger="loop" colors="primary:#ffffff,secondary:#c71f16" stroke="90" scale="13" style="width:250px;height:250px">
                            </lord-icon>
            ...
            <div class="container parallax">
                <div class="row">
                    <div class="col-md-12 fadeInUp sevice-items">
                        <div class="col-lg-3 col-md-6 col-sm-6 bounceInUp animated" style="visibility: visible; animation-name: bounceInUp;">
            ...
            <div class="bg__third">
                <div id="slide">
                    <div class="container">
                        <div class="row ">
                            <div style="width: 100%;">
                                <h2 style="text-align: center !important;font-weight: 600;color:white;margin-bottom: 40px;margin-top:40px;" id="welcome_to_spread_title">Welcome to SPREAD</h2>
                            </div>
                            <div class="line"></div>
                            <div style="background-color: rgba(255, 255, 255, 0.9);padding:50px;border-radius:20px;"><p>Over the past decade, Spread has grown to become the leading oil and gas drilling forum for technical Q&amp;A engineering discussions. The site started with a core team of contributors covering all main specialist areas involved in drilling, exploration, subsea, completion and abandonment of wells. Over time, our team has grown and now includes technical specialists from all over the world who are working with all major oil companies, as well as E&amp;P and service companies.</p>
                                <p>With thousands of discussion threads now indexed in the search engines, newcomers are discovering fresh content every day.</p>
                                <p>With our current number of active members and daily page views, it means that any technical question you might have will be answered quickly and to a high standard. This forum is moderated for quality and accuracy, and old information is updated regularly.</p>
                                <p>Once you have signed up, you can ask your first question right away – or answer somebody else’s question!</p>
                                <p><strong>Welcome to Spread.</strong></p>
                                <div class="button">
                                    <h3><a href="{{route('login')}}" style="color:white;">SIGN UP FOR FREE</a></h3></div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
                ...
                <div class="main-section d-flex flex-wrap pb-4">
                    <div class="main-section-head d-flex flex-wrap align-items-center w-100">
                        <div class="w-100 button-group d-flex justify-content-between mt-4">
                            ...
                            <a href="{{route('discussions.index')}}?unanswered=1" class="btn my-btn text-uppercase">Waiting for responses</a>
                        </div>
                    </div>
                    ...
                    <div class="section-right">
                        ...
                        @foreach($latest_members as $member)
                            <div class="d-flex justify-content-between align-items-center links-group">
                                ...
                                <a href="{{route('organisations.show', $member->organisation_id)}}" class="link-2 font-12">({{$member->organisation->name ?? ''}})</a>
                            </div>
                        @endforeach
                        <a href="{{route('profile.invite')}}" class="btn my-btn btn-invite w-100  font-18">Invite your friends</a>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12">
            ...
            <div class="fifty-container">
                <div class="main-section-spread d-flex flex-wrap">
                    <div class="section-left-spread">
                        <div>
                            <a href="https://rp-squared.com/workshops/beyond-video-conferencing-and-technical-facilitation-service" rel="noopener" target="_blank" class="mt-1 d-block">
                                <picture>
            ...
            <div class="second-section" style="background-color: white">
                <div class="sixty-container">
                    <div class="main-section-spread d-flex flex-wrap mt-5">
                        ...
                        <img  src="{{asset('/img/map5.jpg')}}" alt="my-spread-map" class="w-100 h-auto" loading="lazy">
                    </div>
                </div>
            </div>
            ...
            <div style="background-color: #110b42;">
                <div class="footer-container text-center">
                    <a href="/" class="mr-auto" aria-label="logo">
                        <img src="{{asset('/img/home/logo.png')}}" alt="myspread" width="100" loading="lazy" style="margin-left: -25px;">
                    </a>
                    ...
                    <div class="footer-socials d-flex align-items-center justify-content-center">
                        ...
                        <a href="https://www.facebook.com/Myspread-1655862491362528/" rel="noreferrer" target="_blank" title="facebook" aria-label="facebook">
                            <i class="fa fa-facebook-f"></i>
                        </a>
                        <a href="https://twitter.com/myspread/" rel="noreferrer" target="_blank" title="twitter" aria-label="twitter">
                            <i class="fa fa-twitter"></i>
                        </a>
                        <a href="https://www.linkedin.com/company/my-spread" rel="noreferrer" target="_blank" title="linkedin" aria-label="linkedin">
                ...
                <div class="copyright">
                    <div class="copyright-container text-center">
                        <p class="mb-1 mr-3">{{date('Y')}} &copy; SPREAD. All Rights Reserved. Designated trademarks and brands are the property of their respective owners.</p>
                        <a href="https://ootbinnovations.com/" target="_blank" rel="noopener"><p>DEVELOPED BY OUT OF THE BOX INNOVATION</p></a>
                    </div>
                </div>
