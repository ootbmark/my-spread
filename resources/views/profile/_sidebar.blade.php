<div class="my-profile-menu">
    ...
    <nav class="profile-nav">
        ...
        <div class="user-info">
            <div class="user-info-img position-relative">
                ...
                <div class="avatar-buttons">
                    <button type="button" class="btn edit-img" data-toggle="modal" data-target="#myModal" title="Edit avatar">
                        <img src="{{asset('/img/edit.svg')}}" alt="" width="25">
                    </button>

                    @if(auth()->user()->getRawOriginal('image'))
                        <a href="#" class="delete-avatar" id="delete-avatar" onclick="$(this).next().submit()" title="Delete avatar">
        ...
        <ul class="profile-nav-ul">
            <li @if(Request::is('profile') || Request::is('profile/info') || Request::is('profile/discussions') || Request::is('profile/replies')) class="active" @endif>
            ...
            @if(auth()->user()->role == 'admin')
                <li @if(Request::is('dashboard*') && !Request::is('dashboard/forms*') && !Request::is('dashboard/scribes*') && !Request::is('dashboard/groups-for-quiz*')) class="active" @endif>
